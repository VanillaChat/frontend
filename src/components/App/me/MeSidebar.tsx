...
export default function MeSidebar() {
	...
	return (
		<div className="w-[300px] bg-[#f2f2f2] p-[20px_10px] dark:bg-[#2C2B27] dim:bg-[#101010]">
			<div className="relative w-full max-w-sm">
				...
				/>
				<svg
					className="absolute left-[13px] top-1/2 transform -translate-y-1/2 text-black dark:text-white dim:text-white pointer-events-none"
					width="18"
					height="18"
					viewBox="0 0 18 18"
					fill="none"
			...
			/>
			<p className="font-semibold text-[14px] ml-[3px] my-[8px]">
				{t("app.me.directMessages")}
			</p>
