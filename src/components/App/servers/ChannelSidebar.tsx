	...
	if (server) {
		return (
			<div className="w-[300px] bg-[#f2f2f2] dark:bg-[#2C2B27] dim:bg-[#070707] p-[20px_10px]">
				<div className="bg-[#fbfbfb] border-[1px] border-[#e0e0e0] dark:bg-[#393830] dark:border-[#464540] dim:bg-[#181815] dim:border-[#302F2A] rounded-[8px] mt-[-10px] flex flex-row p-[15px_15px] items-center">
					<div>
						<p className="text-[16px] font-medium mb-[5px]">{server.name}</p>
						<p className="text-[14px] font-normal mt-0">{server?.brief}</p>
					</div>
					<svg
						className="w-[20px] h-[20px] ml-auto text-black dark:text-white dim:text-white"
						width="18"
						height="18"
						viewBox="0 0 18 18"
						fill="none"
