                    ...
                    >
                        <header className="relative flex justify-center items-center flex-col">
                            ...
                            <p className={cn(
                                ...
                                {
                                    "text-red-500 dark:text-red-400 dim:text-red-400": destructive
                                }
                            )}>{title}</p>
                        ...
                        <footer className={cn(
                            ...
                            {!hideCloseButton && <Button onClick={closable ? close : void 0} disabled={!closable}>{t("common.cancel")}</Button>}
                            <Button onClick={onConfirm} filled disabled={confirmDisabled} destructive={destructive}>
                                {confirmText ?? "Confirm"}
                            </Button>
                        </footer>
                    </motion.div>
