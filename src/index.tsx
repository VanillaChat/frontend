	...
	return (
		<ThemeProvider>
			<Toast.Provider>
				...
				<Toast.Portal>
					<Toast.Viewport className="fixed z-[1000] top-auto right-[1rem] bottom-[1rem] mx-auto flex w-[250px] sm:right-[2rem] sm:bottom-[2rem] sm:w-[300px]">
						<ToastList />
					</Toast.Viewport>
				</Toast.Portal>
			</Toast.Provider>
...
function ToastList() {
	...
	return toasts.map((toast) => (
		...
		>
			...
			<Toast.Description className="text-[0.925rem] leading-5 text-gray-700 select-text" />
			<Toast.Close
