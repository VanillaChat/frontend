...
export default function ForgotPassword() {
  ...
  const onSubmit: SubmitHandler<z.infer<typeof ForgotPasswordSchema>> = useCallback(async () => {
  ...
  return (
      <main id="forgot-password" className="flex flex-row justify-center dark:bg-[#262622] dim:bg-black gap-[90px] mt-[10vh] pb-[20px] max-[850px]:flex-col max-[850px]:justify-center max-[850px]:items-center max-[850px]:gap-0 max-[850px]:mt-[5vh]">
        <div className="max-[850px]:flex max-[850px]:flex-col max-[850px]:justify-center max-[850px]:items-center">
          ...
          <h1 className="text-[30px] font-semibold mb-0 text-[#101028] dark:text-white dim:text-white mt-[20.1px]">{t("forgotPassword.title")}</h1>
          <p className="my-[16px] max-w-[420px] max-[850px]:text-center">{t("forgotPassword.subtitle")}</p>
        </div>
        <div className="w-[385px]">
          ...
          <form className="mt-[10px]" onSubmit={handleSubmit(onSubmit)}>
            ...
            >
              {t(isSubmitting ? "forgotPassword.resettingPassword" : "forgotPassword.resetPassword")}
            </Button>
            ...
            <div className="flex items-center my-[25px]">
              ...
              <div className="px-3 text-[#667085] dark:text-white dim:text-white">{t('forgotPassword.goBackTitle')}</div>
              <div className="border-t border-1 border-[#eaecf0] dark:border-[#9b9da3] dim:border-[#9b9da3] flex-grow"></div>
            </div>
            <Button to="/login" style={{ marginTop: "10px" }}>
              <svg className="mr-[5px] pointer-events-none" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
